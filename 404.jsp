    ...
    <div class="outer">
        <div class="middle">
            <div class="inner">
                ...
                <a class="inner-detail" href="#" style="font-size: 1.5em;color:#F4BE2C ;">Give Feedback</a>
                <a class="inner-detail" href="/" style="font-size: 1.8em;color:#38CC77 ;">Return to Home</a>
                <!--END CONTENT-->
            </div>
        </div>
    </div>
